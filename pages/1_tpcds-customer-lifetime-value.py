...
st.set_page_config(page_title="Customer Lifetime Value computation", page_icon="📈")

st.markdown("# Computing Customer Lifetime Value")
st.sidebar.header("Computing Customer Lifetime Value")
st.write(
